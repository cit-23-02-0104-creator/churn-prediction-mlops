...
![MLflow](docs/screenshots/mlflow_experiment_eval.png)

---

## FastAPI — Live Prediction

![FastAPI](docs/screenshots/fastapi_predict_full.png)
...
```text
https://github.com/<YOUR-GITHUB-USERNAME>/churn-prediction-mlops
```
